import { IRouteConfig, IRouteOption, RouteConst } from '../enum';
import { Hashtable } from '../hastable';
import { BaseController } from '../models/baseController';
export function Route(uri?:string):any{ 
    ...
    //         throw "Route decorator was required UriPrefix";
    //     }
    //     let option:IRouteOption=<IRouteOption>{
    //         uri: uri||RouteConst.ROOT_URI,
    //         handlerMethodName:propertyKey
    //     };
    //     routeConfig.addRouteOption(option);
    // }
